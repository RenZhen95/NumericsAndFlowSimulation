...
for n = 1:250
    ...
    [FluxConX_rhou, FluxConY_rhou] = calcFluxConUDS(velu, velv, rhou, Delta);
    % Calculating the convective fluxes for rhov
    [FluxConX_rhov, FluxConY_rhov] = calcFluxConUDS(velu, velv, rhov, Delta);
    % Calculating the convective fluxes for phi
    [FluxConX_phi, FluxConY_phi] = calcFluxConUDS(velu, velv, phi, Delta);
    ...
    if n == 25
        saveas(fig, "Images\DiagJet_UDS1.png")
    elseif n == 75
        saveas(fig, "Images\DiagJet_UDS2.png")
    elseif n == 150
        saveas(fig, "Images\DiagJet_UDS3.png")
    elseif n == 200
        saveas(fig, "Images\DiagJet_UDS4.png")
    end
end